                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <h1 class="display-3 fw-bolder mb-2"><span class="text-gradient">Saya Benedictus
                                    Radyan Dwi Anggoro</span></h1>
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4 mt-3">
                                <div class="text-lowercase">{{ get_meta_value('_kota') }} &middot;
                                    {{ get_meta_value('_provinsi') }} &middot; {{ get_meta_value('_nohp') }} <a
                                        href="mailto:benedictusradyan@gmail.com" style="color:white;">&middot;
                                        {{ get_meta_value('_email') }}</a></div>
                            </div>
                            {{-- <div class="fs-3 fw-light text-muted mb-3">Web Developer</div> --}}
                            <div
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="{{ asset('foto') . '/' . get_meta_value('_foto') }}"
                                    alt="pasfotoben" />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-10">
                            ...
                            <p class="text-muted text-justify">{!! $about->isi !!}</p>
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0">Copyright &copy; Bens Portofolio 2023</div>
                </div>
                {{-- <div class="col-auto">
