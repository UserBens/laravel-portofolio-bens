...
<head>
    ...
    <title>Resume | Bens Portofolio</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="depan/assets/favicon.ico" />
    <!-- Custom Google font-->
...
<body class="d-flex flex-column h-100 bg-light">
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="/"><span class="fw-bolder text-primary">Bens Portofolio</span></a>
    ...
    <!-- Core theme JS-->
    <script src="depan/js/scripts.js"></script>
</body>
